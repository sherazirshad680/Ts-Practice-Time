...
var x: { id: number; [xyz: string]: any }; //Note now 'x' can have any name, just that the property should be of type string

x = { id: 1, fullname: "Sheraz" }; // Ok, `fullname` matched by index signature
x = { id: 1, name: "Sheraz" };
x = { id: 1, lastName: "Sheraz" };
//Case 3
